...
class SttCSVReader(object):
    ...
    def read(self, evtid: int = None):
        ...
        try:
            all_data = trackml.dataset.load_event(event_prefix)  # return parts in default order
        ...
        # Drop duplicates from "particles", depends on data generated by "PndMLTracker" 
        ...
        # Need 'isochrone', 'skewed' & 'sector_id' columns that are in cells.csv
...
def Draw_Reader_Event(data=None, figsize=(10, 10), save_fig=False):
    ...
    for i in p_ids:
        ...
        ax.scatter(df_.x.values, df_.y.values, label='particle_id: {}'.format(i))
